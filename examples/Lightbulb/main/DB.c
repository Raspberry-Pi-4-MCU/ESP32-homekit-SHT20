...
#define KIID_Humidity ((uint64_t)0x0044)
#define KIID_Humidity_Service ((uint64_t)0x0045)
#define KIID_Humidity_Name ((uint64_t)0x0046)
#define KIID_Humidity_detect ((uint64_t)0x0047)
...
const HAPFloatCharacteristic TEMPDetectCharacteristic = {
    ...
    .properties = { .readable = true,
                    ...
                    .ble = { .supportsBroadcastNotification = true,
                             ...
                             .readableWithoutSecurity = false,
                             .writableWithoutSecurity = false } },
    .constraints = { .maximumValue = 30, .minimumValue = 0 },
    .callbacks = { .handleRead = HandleTEMPRead, .handleWrite = NULL }
};
/**
* Humidity
*/
const HAPFloatCharacteristic HumidityDetectCharacteristic = {
    .format = kHAPCharacteristicFormat_Float,
    .iid = KIID_Humidity,
...
const HAPService TEMPService = {
    ...
    .properties = { .primaryService = true, .hidden = false, .ble = { .supportsConfiguration = false } },
    .linkedServices = NULL,
    .characteristics = (const HAPCharacteristic* const[]) { &TEMPDetectCharacteristic,
                                                            NULL }
};
...
* Humidity
*/
const HAPService HumidityService = {
    .iid = KIID_Humidity_Service,
